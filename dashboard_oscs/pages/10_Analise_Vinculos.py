...
if df_71 is not None:
    ...
    st.subheader("1. Pessoal Ocupado por Natureza Jurídica")
    ...
    st.subheader("2. Pessoal Ocupado por Área de Atuação")
    ...
    st.subheader("3. Distribuição por Faixas de Vínculos")
    ...
    st.subheader("4. Finalidade das OSCs x Faixas de Vínculos")
